function [power_OMA, rUAV_OMA, utility_OMA, fUAV_OMA, fUser_OMA] = experiment0_OMA(rUser)
...
power_OMA = recordOffloadPower;
rUAV_OMA = rUAV;
% utilitySeq_OMA = utilitySeq(1: numIteration);
fUAV_OMA = fUAV;
fUser_OMA = fUser;
utility_OMA = [E_user_offload, E_user_comp, E_uav_comp, E_uav_move];
